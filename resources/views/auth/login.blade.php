...
<div class="block p-6 rounded-lg shadow-lg bg-white max-w-sm">
    <form>
      <div class="form-group mb-6">
        <label for="exampleInputEmail2" class="form-label inline-block mb-2 text-gray-700">Adresse e-mail</label>
        <input type="email" class="form-control
          ...
          ease-in-out
          m-0
          focus:text-gray-700 focus:bg-white focus:border-red-600 focus:outline-none" id="exampleInputEmail2"
          aria-describedby="emailHelp" placeholder="Votre addresse e-mail">
      </div>
      <div class="form-group mb-6">
      ...
      <p class="text-gray-800 mt-6 text-center">Pas de compte ?<a href="#!"
