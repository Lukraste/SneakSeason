                  ...
                  @foreach ($brands as $brand)
                    <div class="bg-white">
                      ...
                      @foreach ($brand->collections as $collection)
                        <a href="{{ route('collections.show', ['slug' => $collection->slug]) }}" aria-current="true" class="block py-2 text-primary border-b border-gray-300 w-38 hover:underline transition duration-150 ease-in-out flex items-center">
