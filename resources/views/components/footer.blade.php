        ...
        <div class="mx-auto container py-16 xl:px-20 lg:px-12 sm:px-6 px-4">
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 md:gap-8 gap-4">
                <div class="flex flex-col flex-shrink-0">
                    <h1 class="text-xl">SneakSeason</h1>
                    <p class="text-sm leading-none text-gray-800 mt-4 dark:text-white">Copyright © 2022 SneakSeason</p>
                    <p class="text-sm leading-none text-gray-800 mt-4 dark:text-white">Tous droits réservés</p>
                    <div class="flex items-center gap-x-4 mt-12">
                        <a href="https://www.instagram.com/">
                            <img class="white" src="{{ asset('storage/images/icons/instagram-icon.png')}}" alt="instagram-icon">
                        </a>
                        <a href="https://www.facebook.com/">
                            <img class="white" src="{{ asset('storage/images/icons/facebook-icon.png')}}" alt="facebook-icon">
                        </a>
                        <a href="https://twitter.com/">
                            <img class="white" src="{{ asset('storage/images/icons/twitter-icon.png')}}" alt="twitter-icon">
                        </a>
                    </div>
                </div>
                <div class="sm:ml-0 ml-8 flex flex-col">
                    ...
                    <a href="javascript:void(0)" class="focus:outline-none focus:underline hover:text-gray-500 text-base leading-4 mt-6 text-gray-800 dark:text-white cursor-pointer">Contact us</a>
